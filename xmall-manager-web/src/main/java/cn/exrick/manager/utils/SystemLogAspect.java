package cn.exrick.manager.utils;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(cn.exrick.manager.utils.SystemControllerLog)")
     ...
     * Service层切点,注解方式
     */
    @Pointcut("@annotation(cn.exrick.manager.utils.SystemServiceLog)")
